  ...
  return (
    <View style={styles.container}><ScrollView style={styles.scroll}>
      ...
      <View>
        ...
        <View style={styles.standard2}>
          <View style={styles.imgAndText}>
            <Image style={styles.img2} source={require('../assets/galataport.jpg')}>
        ...
        <View style={styles.standard2}>
          <View style={styles.imgAndText}>
            <Image style={styles.img2} source={require('../assets/kuzguncuk.jpg')}>
        ...
        <View style={styles.standard2}>
          <View style={styles.imgAndText}>
            <Image style={styles.img2} source={require('../assets/galata_tower.jpg')}>
